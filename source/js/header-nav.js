...
function closeMenu() {
  headerOpen.classList.remove("burger-button-close--closed");
  headerClose.classList.add("burger-button-close--closed");
...
headerBtn.addEventListener("click", () => {
  if (!headerOpen.classList.contains("burger-button-close--closed")) {
    headerOpen.classList.add("burger-button-close--closed");
    headerClose.classList.remove("burger-button-close--closed");
